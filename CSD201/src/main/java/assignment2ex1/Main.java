...
public class Main {
    ...
    private static BinaryTree<Book> tBooks = null;
    ...
    private static void funcBook() {
        ...
        do {
            ...
            System.out.println("1.10. [EXIT FUNCTION]");
            ...
            do {
                ...
                try {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        funcBook_traverseInOrder();
                        break;
                    case 4:
                        funcBook_traverseBreadthFirst();
                        break;
                    case 5:
                        funcBook_traverseInOrder_ToFile();
                        break;
                    case 6:
                    ...
                    case 7:
                        ...
                        break;
                    case 8:
                        funcBook_SimplyBalancing();
                        break;
                    case 9:
                        funcBook_CountNumberOfBooks();
                        break;
                    case 10:
    ...
    private static void funcBook_LoadData() {
        ...
        try {
            ...
            while ((str = br.readLine()) != null) {
                ...
                tBooks.insert(new Book(data[0].trim(), data[1].trim(), Integer.parseInt(data[2].trim()), 0,
    ...
    private static void funcBook_InsertData() {
        String bcode, name;
        int quantity;
        double price;
        ...
        tBooks.insert(new Book(bcode, name, quantity, 0, price));
    }

    private static void funcBook_traverseInOrder() {
        tBooks.inorder();
    }

    private static void funcBook_traverseBreadthFirst() {
        tBooks.breadth();
    }

    private static void funcBook_traverseInOrder_ToFile() {
        File fBooks = new File("lms-books.txt");
        ...
        try {
            ...
            tBooks.inorder_file(tBooks.root, br);
    ...
    private static Book funcBook_SearchByBCode() {
        ...
        tmp_book.setBcode(bcode);

        Object o = tBooks.search(tmp_book);
        if (o != null) {
            System.out.println(((Book) o).getInfo());
            return (Book) o;
        }
    ...
    private static void funcBook_DeleteByBCode() {
        ...
        tBooks.delete(getBookByBcode(bcode));

        System.out.println(">> Done!");
    }

    private static void funcBook_SimplyBalancing() {
        // chua lam ham nay
        System.out.println("This method have not developed yet!");
    }

    private static void funcBook_CountNumberOfBooks() {
        System.out.println("Number of books: " + tBooks.count());
    }
    // #endregion
    ...
    // Ki?m tra trong listbook có bcode không
    private static boolean listBookContainBCode(String bcode) {
        if (getBookByBcode(bcode) == null)
            return false;
        else
            return true;
    }

    // Ki?m tra trong listreader có rcode không
